...
const SHARE_LINK_BASE_URL = process.env.SHARE_LINK_BASE_URL || 'http://localhost:3000';

export const shareLink = async (req: Request & { userId?: string }, res: Response): Promise<void> => {

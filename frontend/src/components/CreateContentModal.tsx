    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await apiWithAuth.post('/content', {
                ...formData,
                tags: formData.tags ? formData.tags.split(',').map(tag => tag.trim()) : [] // Ensuring tags are an array
            }, {
                headers: {
            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-md relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input type="text" id="link" name="link" value={formData.link} onChange={handleInputChange}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder="Enter content link" disabled={isLoading} required />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="title" name="title" value={formData.title} onChange={handleInputChange}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder="Enter content title" disabled={isLoading} required />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="tags" name="tags" value={formData.tags} onChange={handleInputChange}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder="Enter tags (comma-separated)" disabled={isLoading} />
                    </div>

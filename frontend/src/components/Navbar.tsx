...
export const Navbar = ({
    ...
    return (
        <header className={`bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 p-4 fixed top-0 left-0 right-0 z-20 h-18 shadow-md transition-transform duration-300 ${isVisible ? "translate-y-0" : "-translate-y-full"}`}>
            <div
                className={`max-w-[1920px] mx-auto flex items-center gap-4 ${isSidebarCollapsed ? "pl-16" : "pl-48"

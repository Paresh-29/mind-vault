...
<div
	...
	<div className="p-3">
		...
		{/* Embedded Content */}
		{type === "youtube" && (
		<div className="aspect-video bg-gray-100 rounded-lg mb-2 h-[157px]">
			<iframe className="w-full h-full rounded-lg" src={getYouTubeEmbedUrl(link)} title="YouTube video player"
				frameBorder="0"
		...
		{type === "twitter" && (
		<div className="bg-gray-100 rounded-lg mb-2 h-[250px] overflow-hidden">
